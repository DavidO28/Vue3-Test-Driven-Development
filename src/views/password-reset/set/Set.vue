<template>
  <div
    class="col-lg-6 offset-lg-3 col-sm-8 offset-sm-2"
    data-testid="password-reset-set-page"
  >
    <form class="card" @submit.prevent="submit">
      ...
      <div class="card-body">
        ...
        <div class="text-center">
          <AppButton class="btn btn-primary" :disabled="isDisabled || apiProgress">
            {{ $t('passwordReset.set') }}
          </AppButton>
        </div>
      </div>
...
const submit = async () => {
  ...
  try {
    const response = await passwordSet(route.query.tk, {
